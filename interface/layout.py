...
class MPSELayout:
    def __init__(self,app):
        ...
        self.layout = html.Div([
            ...
            dbc.Row([
                    dbc.Col(dbc.FormGroup([ dbc.Label("Dataset", html_for="dataset-dropdown"), self.datasetDropdown()]),width=1),
                    ...
                    dbc.Col(dbc.FormGroup([ dbc.Label("Perplexity", html_for="perplexity"), self.perplexity()]),width=1),
                     dbc.Col(dbc.FormGroup([ dbc.Label("Max Iter", html_for="max_iter"), self.max_iters()]),width=1),
                      dbc.Col(dbc.FormGroup([ dbc.Label("Smart Init.", html_for="smart_initialization"), self.smart_initialization()]),width=2),
